...
TLDR: 
    - push_back() tries to move construct if possible, then default to copy construct. (in-place)
    - emplace_back() directly let's you access the constructors of the underlying class
*/
...
void runExamples() {
    ...
    cout << "Case 3:" << endl;
    vec.push_back(Item('3')); // in-place move construct + destructor for temporary
    cout << endl;
    ...
    cout << "Case 5:" << endl;
    vec.emplace_back('5'); // directly construct using parameterized constructor, no move/copy
    cout << endl;
    ...
    cout << "Case 7:" << endl;
    vec.emplace_back(Item('7')); // in-place move construct + destructor for temporary
    cout << endl;
